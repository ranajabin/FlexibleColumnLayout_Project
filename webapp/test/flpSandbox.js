		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table",
									"targetURL": "#flexiblelayoutflexiblelayoutableproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flexiblelayoutflexiblelayoutableproject-display": {
								"semanticObject": "flexiblelayoutflexiblelayoutableproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flexiblelayout.flexiblelayoutableproject",
									"url": sap.ui.require.toUrl("flexiblelayout/flexiblelayoutableproject")
								}
							}
						}
					}
